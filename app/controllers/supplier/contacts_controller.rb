  ...
  def create
    ...
    if @contact.save
      ...
      @client.messages.create(
        ...
        body: "Hey there! #{@contact.first_name}. #{current_user.first_name.capitalize} from #{current_user.business_name} just added you to PetroHub.org so you can get daily fuel price updates."
                 )
