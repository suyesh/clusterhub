class Admin::UsersController < Admin::ApplicationController
  ...
  def user_params
    params.require(:user).permit(:first_name, :last_name, :business_name, :phone_number, :cell_number, :street_address, :apt_suite, :city, :state, :zip_code, :tax_id, :ssn, :in_biz, :terms,:role, :status, :email, :password, :password_confirmation)
  end
end
